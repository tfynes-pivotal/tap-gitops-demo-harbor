...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-demo-harbor
echo     https://github.com/tfynes-pivotal/tap-gitops-demo-harbor
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-demo-harbor --public
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-demo-harbor
git branch -M main
